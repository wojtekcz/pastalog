...
exports.addLogPoint = addLogPoint;
...
function updateObject() {
  ...
  if (state === null) {
    return (0, _immutable.fromJS)(_defineProperty({}, key, current));
  }
  return state.update(key, (0, _immutable.fromJS)({}), function (val) {
...
function disable(_state, category, id) {
  var state = _state;
  state = state.updateIn(['disabled', category, id], function () {
    return true;
  });
  return updateScaleHelper(state);
}

function enable(_state, category, id) {
  var state = _state;
  state = state.deleteIn(['disabled', category, id]);
  return updateScaleHelper(state);
}

function updateScaleHelper() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Map)();

  var logs = state.get('logs', (0, _immutable.Map)());
  var scale = INITIAL_STATE.get('scale', (0, _immutable.Map)());
  (0, _helpers.forEachEnabledSeries)(logs, state.get('disabled', (0, _immutable.Map)()), function (modelName, seriesName, lists) {
    var shouldUpdateScale = state.get('noAutoUpdate', false) === false;
    var isEnabled = (0, _helpers.isSeriesEnabled)(state.get('disabled', (0, _immutable.Map)()), modelName, seriesName);
...
function initializeScale() {
  ...
  var scale = state.get('scale', (0, _immutable.Map)());
  (0, _helpers.forEachEnabledSeries)(logs, state.get('disabled', (0, _immutable.Map)()), function (modelName, seriesName, lists) {
    var minX = lists.get('indices').min();
    var maxX = lists.get('indices').max();
    var minY = lists.get('values').min();
...
function updateScale() {
  ...
  return updateObject(state, 'scale', rescale(state.get('scale', (0, _immutable.Map)()), index, value, index, value));
}
...
function addLogPoint() {
  var _state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Map)();
  ...
  return state.updateIn(['logs', modelName, seriesName], (0, _immutable.Map)(), function (list) {
    return list.update('indices', (0, _immutable.List)(), function (arr) {
      return arr.push(index);
    }).update('values', (0, _immutable.List)(), function (arr) {
...
exports.isSeriesEnabled = isSeriesEnabled;
exports.forEachSeries = forEachSeries;
exports.forEachEnabledSeries = forEachEnabledSeries;
exports.mapSeries = mapSeries;
exports.mapEnabledSeries = mapEnabledSeries;

var _immutable = __webpack_require__(19);

var _lib = __webpack_require__(129);

function isDisabled(state, category, id) {
  return state.get('disabled', (0, _immutable.Map)()).get(category, (0, _immutable.Map)()).get(id, false) === true;
}

function isSeriesEnabled() {
  var disabled = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Map)();
  var modelName = arguments[1];
  var seriesName = arguments[2];

  var model = disabled.getIn(['models', modelName], false);
  var series = disabled.getIn(['series', seriesName], false);
  var unique = disabled.getIn(['uniques', (0, _lib.getUUID)(modelName, seriesName)], false);
...
function reducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _actions.INITIAL_STATE;
  var action = arguments[1];

  switch (action.type) {
    case 'RESCALE':
      return (0, _actions.updateObject)(state, 'scale', action.scale);
    ...
    case 'SET_ANCHORS':
      return (0, _actions.setObject)(state, 'anchors', action.anchors);
    case 'RESIZE':
      return (0, _actions.updateObject)(state, 'size', action.size);
    case 'MOVE_HOVER':
      return (0, _actions.updateObject)(state, 'hoverPosition', action.coords);
    case 'DISABLE':
      return (0, _actions.disable)(state, action.category, action.id);
    case 'ENABLE':
      return (0, _actions.enable)(state, action.category, action.id);
    case 'TOGGLE_HOVER':
      return (0, _actions.toggleHover)(state, action.value);
    case 'INITIALIZE_LOGS':
      return (0, _actions.initializeLogs)(state, action.logs);
    case 'UPDATE_MODEL':
      return (0, _actions.addLogPoint)(state, action.modelName, action.seriesName, action.index, action.value);
    case 'DELETE':
...
var _mocha = __webpack_require__(133);

var _chai = __webpack_require__(40);
...
(0, _mocha.describe)('Redux store', function () {
  (0, _mocha.it)('is initialized with the correct reducer', function () {
    var store = (0, _store2.default)();
    (0, _chai.expect)(store.getState()).to.equal(_actions.INITIAL_STATE);

    store.dispatch({
      type: 'RESCALE',
      scale: { minX: 10 }
    });
    (0, _chai.expect)(store.getState()).to.equal(_actions.INITIAL_STATE.updateIn(['scale', 'minX'], function () {
      return 10;
    }));
  });
});

(0, _mocha.describe)('Log', function () {
  (0, _mocha.describe)('initialization', function () {
    (0, _mocha.it)('should add initial values for log', function () {
      var initialState = (0, _immutable.fromJS)({});
      var logs = (0, _immutable.fromJS)({
        modelA: {
          trainLoss: {
            values: [12, 13, 14, 15],
            indices: [0, 1, 2, 3]
      ...
      var newState = (0, _reducer2.default)(initialState, {
        type: 'INITIALIZE_LOGS',
        logs: logs
      });
      (0, _chai.expect)(newState.get('logs')).to.equal(logs);
    });

    (0, _mocha.it)('should change the scaling on initialization', function () {
      var initialState = _actions.INITIAL_STATE;
      var logs = (0, _immutable.fromJS)({
        modelA: {
          trainLoss: {
            values: [12, 13, 14, 15],
      ...
      (0, _chai.expect)(initialState.get('scale')).to.equal(_actions.INITIAL_STATE.get('scale'));
      (0, _chai.expect)(newState.get('scale')).to.not.equal(_actions.INITIAL_STATE.get('scale'));
    });
  });

  (0, _mocha.describe)('updates', function () {
    (0, _mocha.it)('should update values for log', function () {
      var initialState = (0, _immutable.fromJS)({
      ...
      (0, _chai.expect)(newState).to.equal(initialState.updateIn(['logs', 'modelA', 'trainLoss', 'values'], function (arr) {
        return arr.push(16);
    ...
    (0, _mocha.it)('should update scales for log', function () {
      var initialState = _actions.INITIAL_STATE.merge((0, _immutable.fromJS)({
        logs: { modelA: { trainLoss: { values: [12, 13, 14, 15], indices: [0, 1, 2, 3] } } }
      }));
      var newState = (0, _reducer2.default)(initialState, {
        type: 'UPDATE_MODEL',
      ...
      (0, _chai.expect)(newState.getIn(['scale', 'maxX'], 0)).to.be.above(1000);
      (0, _chai.expect)(newState.getIn(['scale', 'maxY'], 0)).to.be.above(10000);
    });

    (0, _mocha.it)('should NOT update scales if noAutoUpdate is true', function () {
      var initialState = (0, _reducer2.default)(_actions.INITIAL_STATE.merge((0, _immutable.fromJS)({
        logs: { modelA: { trainLoss: { values: [12, 13, 14, 15], indices: [0, 1, 2, 3] } } }
      })), {
      ...
      (0, _chai.expect)(newState.getIn(['scale', 'maxX'], 0)).to.be.below(1000);
      (0, _chai.expect)(newState.getIn(['scale', 'maxY'], 0)).to.be.below(10000);
    });

    (0, _mocha.it)('should update values for models that dont exist', function () {
      var initialState = (0, _immutable.fromJS)({
        logs: { modelA: { trainLoss: { values: [12, 13, 14, 15], indices: [0, 1, 2, 3] } } }
      });
      var newState = (0, _reducer2.default)(initialState, {
      ...
      (0, _chai.expect)(newState).to.equal(initialState.updateIn(['logs', 'modelB', 'validLoss', 'values'], (0, _immutable.fromJS)([]), function (arr) {
        return arr.push(16);
      }).updateIn(['logs', 'modelB', 'validLoss', 'indices'], (0, _immutable.fromJS)([]), function (arr) {
        return arr.push(4);
      }));
    });
  });
...
(0, _mocha.describe)('App state actions', function () {
  (0, _mocha.describe)('rescale', function () {
    (0, _mocha.it)('should toggle the menu', function () {
      var initialState = (0, _immutable.fromJS)({});
      var newState = (0, _reducer2.default)(initialState, {
        type: 'TOGGLE_SCALE_MENU'
      });
      (0, _chai.expect)(newState.get('scaleMenu')).to.equal(true);
    });

    (0, _mocha.it)('should set if dragging is being done', function () {
      var initialState = (0, _immutable.fromJS)({});
      var newState = (0, _reducer2.default)(initialState, {
        type: 'SET_DRAG', value: true
      });
      (0, _chai.expect)(newState.get('dragging')).to.equal(true);
    });

    (0, _mocha.it)('should set initial anchors for drags', function () {
      var initialState = (0, _immutable.fromJS)({});
      var anchors = { x: 50, y: 20 };
      var newState = (0, _reducer2.default)(initialState, {
        type: 'SET_ANCHORS', anchors: anchors
      });
      (0, _chai.expect)(newState.get('anchors')).to.equal(anchors);
    });

    (0, _mocha.it)('should work for state variables with no scale property', function () {
      var initialState = (0, _immutable.fromJS)({});
      ...
      (0, _chai.expect)(newState.get('scale')).to.equal((0, _immutable.fromJS)(newScale));
    });

    (0, _mocha.it)('should work for state variables that are null', function () {
    ...
    (0, _mocha.it)('should apply defaults when state variable is undefined', function () {
      ...
      var updatedDefaults = _actions.INITIAL_STATE.get('scale').update('xMin', function () {
        return 10;
      });
      (0, _chai.expect)(newState.get('scale')).to.equal(updatedDefaults);
    });

    (0, _mocha.it)('should update multiple values for scale at once', function () {
      var initialState = (0, _immutable.fromJS)({ scale: {} });
    ...
    (0, _mocha.it)('should work when update only includes some keys', function () {
      var initialState = (0, _immutable.fromJS)({ scale: { xMin: 10, xMax: 30 } });
      var newScale = { xMax: 30, yMax: 40 };
      var newState = (0, _reducer2.default)(initialState, {
        type: 'RESCALE',
        scale: newScale
      });
      (0, _chai.expect)(newState.get('scale')).to.equal((0, _immutable.fromJS)({
        xMin: 10, xMax: 30, yMax: 40
      }));
    });
  });

  (0, _mocha.describe)('resize', function () {
    (0, _mocha.it)('should update multiple values for size at once', function () {
      var initialState = (0, _immutable.fromJS)({ size: { width: 100, height: 200 } });
      var newSize = { height: 1000, width: 1000 };
      var newState = (0, _reducer2.default)(initialState, {
        type: 'RESIZE',
        size: newSize
      });
      (0, _chai.expect)(newState.get('size')).to.equal((0, _immutable.fromJS)(newSize));
    });
  });

  (0, _mocha.describe)('moveHover', function () {
    (0, _mocha.it)('should update multiple values for coordinates at once', function () {
      var initialState = (0, _immutable.fromJS)({ hoverPosition: { hoverX: 100, hoverY: 200 } });
      var newCoords = { hoverX: 1000, hoverY: 1000 };
      var newState = (0, _reducer2.default)(initialState, {
        type: 'MOVE_HOVER',
        coords: newCoords
      });
      (0, _chai.expect)(newState.get('hoverPosition')).to.equal((0, _immutable.fromJS)(newCoords));
    });
  });

  (0, _mocha.describe)('disable/enable', function () {
    (0, _mocha.it)('should disable a model when no keys exist', function () {
      var initialState = (0, _immutable.fromJS)({});
      var newState = (0, _reducer2.default)(initialState, {
        type: 'DISABLE',
        category: 'models',
      ...
      (0, _chai.expect)((0, _helpers.isDisabled)(newState, 'models', 'modelA')).to.equal(true);
    });

    (0, _mocha.it)('should disable a series type', function () {
      var initialState = (0, _immutable.fromJS)({});
      var newState = (0, _reducer2.default)(initialState, {
        type: 'DISABLE',
        category: 'series',
      ...
      (0, _chai.expect)((0, _helpers.isDisabled)(newState, 'series', 'train_loss')).to.equal(true);
    });

    (0, _mocha.it)('should disable a unique model/series', function () {
      var initialState = (0, _immutable.fromJS)({});
      var newState = (0, _reducer2.default)(initialState, {
        type: 'DISABLE',
        category: 'uniques',
      ...
      (0, _chai.expect)((0, _helpers.isDisabled)(newState, 'uniques', 'modelA/train_loss')).to.equal(true);
    });

    (0, _mocha.it)('should enable disabled elements', function () {
      var initialState = (0, _immutable.fromJS)({ disabled: { models: { modelA: true } } });
      var newState = (0, _reducer2.default)(initialState, {
        type: 'ENABLE',
        category: 'models',
        id: 'modelA'
      });
      (0, _chai.expect)((0, _helpers.isDisabled)(newState, 'model', 'modelA')).to.equal(false);
    });

    (0, _mocha.it)('should do nothing when enabled elements are enabled again', function () {
      var initialState = (0, _immutable.fromJS)({ disabled: { models: {} } });
      var newState = (0, _reducer2.default)(initialState, {
        type: 'ENABLE',
        category: 'models',
        id: 'modelA'
    ...
    (0, _mocha.it)('should do nothing when disabled elements are disabled again', function () {
      var initialState = (0, _immutable.fromJS)({ disabled: { models: { modelA: true } } });
      var newState = (0, _reducer2.default)(initialState, {
        type: 'DISABLE',
        category: 'models',
  ...
  (0, _mocha.describe)('toggle hover', function () {
    (0, _mocha.it)('should set hover to true', function () {
      var initialState = (0, _immutable.fromJS)({ hovering: false });
      var newState = (0, _reducer2.default)(initialState, {
        type: 'TOGGLE_HOVER',
        value: true
      });
      (0, _chai.expect)(newState.get('hovering')).to.equal(true);
      var newState2 = (0, _reducer2.default)(initialState, {
        type: 'TOGGLE_HOVER',
        value: true
      });
      (0, _chai.expect)(newState2.get('hovering')).to.equal(true);
    });

    (0, _mocha.it)('should set hover to false', function () {
      var initialState = (0, _immutable.fromJS)({ hovering: true });
      var newState = (0, _reducer2.default)(initialState, {
        type: 'TOGGLE_HOVER',
        value: false
      });
      (0, _chai.expect)(newState.get('hovering')).to.equal(false);
    });
  });

  (0, _mocha.describe)('misc', function () {
    (0, _mocha.it)('should toggle autoupdate', function () {
      var initialState = _actions.INITIAL_STATE;
      var newState = (0, _reducer2.default)(initialState, {
        type: 'TOGGLE_AUTO_UPDATE'
      });
      (0, _chai.expect)(newState.get('noAutoUpdate')).to.equal(true);
    });
  });
});
...
var chaiImmutable = __webpack_require__(132);
...
exports.rightPadDecimals2 = rightPadDecimals2;
exports.convertScales = convertScales;
exports.getUUID = getUUID;
exports.stringToColor = stringToColor;

var _map2 = __webpack_require__(123);
...
function convertScales(list, minIn, maxIn, minOut, maxOut) {
  ...
  if (options.invert === true) {
    return (0, _map3.default)(list, function (val) {
...
exports.default = {
  stringToColor: stringToColor, getUUID: getUUID, convertScales: convertScales, rightPadDecimals2: rightPadDecimals2, round2: round2
};
...
module.exports = require("chai-immutable");
